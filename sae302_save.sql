...
--
-- Dumping data for table `channel_access`
--

LOCK TABLES `channel_access` WRITE;
/*!40000 ALTER TABLE `channel_access` DISABLE KEYS */;
/*!40000 ALTER TABLE `channel_access` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-12-31 13:04:26
